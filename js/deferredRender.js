(function() {
    ...
    R.pass_deferred.render = function(state) {
        ...
        if (cfg.enableScissor && cfg.debugScissor) {
        ...
        if (cfg.enableCel) {
          gl.useProgram(R.prog_CelContour.prog);
          gl.uniform2f(R.prog_CelContour.u_texSize, width, height);
          gl.blendEquation(gl.FUNC_REVERSE_SUBTRACT);
          gl.blendFunc(gl.ONE,gl.ONE);
          renderFullScreenQuad(R.prog_CelContour);
        }
    ...
    var bindTexturesForLightPass = function(prog) {
        ...
        gl.uniform1i(prog.u_celShade, cfg.enableCel);
        gl.uniform1i(prog.u_celRamp, R.NUM_GBUFFERS+1);
    };
    ...
    R.pass_bloom.render = function(state) {
        ...
        gl.bindFramebuffer(gl.FRAMEBUFFER, R.pass_bloom.extractFbo);
        gl.activeTexture(gl.TEXTURE0);
        gl.bindTexture(gl.TEXTURE_2D, R.pass_deferred.colorTex);
